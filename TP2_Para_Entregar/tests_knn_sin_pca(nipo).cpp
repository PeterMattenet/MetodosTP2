...
void testKnnSinPcaReduced(int kFoldValue){
	...
	string nombreFile;
	if(kFoldValue == 2){
		nombreFile = "resultados_tests_knn_sin_pca/asd1.csv";
	}
	if(kFoldValue == 5){
		nombreFile = "resultados_tests_knn_sin_pca/asd2.csv";	
	}
	if(kFoldValue == 10){
		nombreFile = "resultados_tests_knn_sin_pca/asd3.csv";
	}
...
void testKnnSinPca(int kFoldValue){
	...
	string nombreFile;
	if(kFoldValue == 2){
		nombreFile = "resultados_tests_knn_sin_pca/asf3.csv";
	}
	if(kFoldValue == 5){
		nombreFile = "resultados_tests_knn_sin_pca/asf2.csv";	
	}
	if(kFoldValue == 10){
		nombreFile = "resultados_tests_knn_sin_pca/asf3.csv";
	}
